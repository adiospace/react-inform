...
function form() {
  ...
  return function (Wrapped) {
    ...
    return _temp2 = _class = function (_Component) {
      ...
      _createClass(FormWrapper, [{
        ...
        value: function baseProps(name) {
          ...
          return {
            ...
            onBlur: function onBlur() {
              if (_this7.props.blurTouch) _this7.touch([name]);
            },
            value: values[name] || '',
        ...
        value: function render() {
          var _props = this.props,
              ...
              blurTouch = _props.blurTouch,
              otherProps = _objectWithoutProperties(_props, ['value', 'onChange', 'onValidate', 'validate', 'fields', 'blurTouch']);
      ...
      blurTouch: _react.PropTypes.bool,
